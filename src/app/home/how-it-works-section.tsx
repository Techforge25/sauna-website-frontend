...
function BookingStepCard({
  ...
  return (
    <article
      className={
        isFeatured
          ? "relative overflow-hidden rounded-xl bg-[#221916] p-[22px] text-white shadow-[0_14px_40px_rgba(0,0,0,0.22)] before:pointer-events-none before:absolute before:inset-x-0 before:top-0 before:h-[1px] before:bg-gradient-to-r before:from-transparent before:via-primary/60 before:to-transparent after:pointer-events-none after:absolute after:bottom-0 after:inset-x-0 after:h-[2px] after:bg-gradient-to-r after:from-transparent after:via-primary/60 after:to-transparent lg:ml-[109px] lg:max-w-[379px]"
